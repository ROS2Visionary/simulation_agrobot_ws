...
def generate_launch_description():
    ...
    map_yaml_path = os.path.join(get_package_share_directory("agrobot_mapping"),"maps","map.yaml")
    ...
    keepout_filter_node = IncludeLaunchDescription(
        ...
        launch_arguments={
            "mask_yaml_file":os.path.join(get_package_share_directory("agrobot_mapping"),"maps","map_mask.yaml")
        }.items()
    )
